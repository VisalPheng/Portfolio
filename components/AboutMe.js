        ...
        <div className='pt-20 grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-20 gap-x-20'>
          ...
          <div className='col-span-1 md:col-span-2'>
            ...
            <div className='flex flex-row flex-wrap mt-8'>
              ...
              />
              <img
                src='https://i.imgur.com/sXesgTL.png'
                className='object-scale-down h-20 w-20 mx-4 my-4'
              />
              <img
              ...
              />
              <img
                src='https://i.imgur.com/M8kLKoX.png'
                className='object-scale-down h-20 w-20 mx-4 my-4'
              />
              <img
                src='https://i.imgur.com/suLu9YK.png'
                className='object-scale-down h-20 w-20 mx-4 my-4'
              />
              <img
                src='https://i.imgur.com/Bt59LuF.png'
                className='object-scale-down h-20 w-20 mx-4 my-4'
              />
              <img
              ...
              />
              <img
                src='https://i.imgur.com/jlFueqk.png'
                className='object-scale-down h-20 w-20 mx-4 my-4'
              />
            </div>
          </div>
